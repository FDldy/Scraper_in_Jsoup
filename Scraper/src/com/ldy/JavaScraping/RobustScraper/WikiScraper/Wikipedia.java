package com.ldy.JavaScraping.RobustScraper.WikiScraper;
...
import com.ldy.JavaScraping.RobustScraper.Tools.IPResolver;
import com.ldy.JavaScraping.RobustScraper.Tools.Webpage;

public class Wikipedia {
	/**
	* Crawls both English and German Wikipedia. Finds 10 random German Wikipedias by following redirects
	...
	*/
	...
	private static String getRandomHist(String language) throws IOException {
		...
		String randHist = randomUrl.replace("https://"+language+".wikipedia.org/wiki/","");
